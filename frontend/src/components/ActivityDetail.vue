<template>
    <div class="flex flex-col h-full bg-gray-50 dark:bg-gray-900 pb-20 transition-colors duration-300">
      ...
      <div class="bg-white dark:bg-gray-800 px-4 py-3 shadow-sm z-10 flex justify-between items-center shrink-0 border-b border-transparent dark:border-gray-700 transition-colors">
      ...
      <div class="flex-1 overflow-y-auto px-4 pt-6 pb-28 space-y-6">
        ...
        <div class="flex flex-wrap items-center gap-2 mt-3 text-sm text-gray-500 dark:text-gray-400 transition-colors">
    ...
    <transition enter-active-class="transition-all duration-300 ease-out" enter-from-class="opacity-0 translate-y-full" enter-to-class="opacity-100 translate-y-0" leave-active-class="transition-all duration-200 ease-in" leave-from-class="opacity-100 translate-y-0" leave-to-class="opacity-0 translate-y-full">
      <div v-if="showResponsiblesModal" class="fixed inset-0 z-50 flex flex-col justify-end">
        ...
        <div class="relative bg-white dark:bg-gray-800 w-full h-[60vh] rounded-t-3xl shadow-2xl flex flex-col z-10 overflow-hidden transition-colors">
