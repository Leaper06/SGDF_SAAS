<template>
    <div class="flex flex-col h-full bg-white dark:bg-gray-900 pb-20 relative transition-colors duration-300">
        
        <!-- BANDEAU BLEU SGDF -->
        <div class="bg-[#004267] dark:bg-[#002a42] h-[35%] rounded-b-[40px] shadow-lg flex flex-col items-center justify-center p-6 relative overflow-hidden shrink-0 transition-colors">
        ...
        <div class="flex-1 px-8 pt-10 flex flex-col">
            <h2 class="text-xl font-extrabold text-gray-900 dark:text-white mb-6 text-center transition-colors">Connexion Intranet</h2>
            ...
            <div class="space-y-5">
                <div>
                    ...
                    <input 
                        ...
                        class="w-full bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-white font-medium rounded-xl px-4 py-3.5 focus:outline-none focus:ring-2 focus:ring-[#004267]/50 dark:focus:ring-blue-500/50 focus:bg-white dark:focus:bg-gray-900 transition-all"
            ...
            <!-- MESSAGE D'ERREUR -->
            <div v-if="loginError" class="mt-4 p-3 bg-red-50 dark:bg-red-900/30 border border-red-100 dark:border-red-800/50 rounded-xl flex items-start gap-2 transition-colors">
            ...
            <!-- MESSAGES D'ATTENTE -->
            <p v-if="isLoggingIn" class="text-center text-xs text-gray-400 dark:text-gray-500 mt-3 italic animate-pulse transition-colors">
                Vérification auprès de l'intranet... (cela peut prendre quelques secondes) 
            </p>
            <p v-if="isLoggingIn" class="text-center text-sm text-gray-600 dark:text-gray-400 mt-3 italic animate-pulse transition-colors">
