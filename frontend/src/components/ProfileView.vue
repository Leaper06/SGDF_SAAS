<template>
  <div class="flex-1 overflow-y-auto p-6 space-y-8 pb-36 bg-gray-50 dark:bg-gray-900 h-full transition-colors duration-300">
    ...
    <div>
        ...
        <div class="space-y-3">
            ...
            >
                ...
                <button @click.prevent="supprimerLien(index)" class="text-gray-300 dark:text-gray-500 hover:text-red-500 dark:hover:text-red-400 p-1 transition-colors">
    ...
    <div class="pt-6 pb-8">
        <button @click="logout" class="w-full bg-red-50 dark:bg-red-500/10 hover:bg-red-100 dark:hover:bg-red-500/20 text-red-600 dark:text-red-400 font-bold py-4 rounded-2xl transition-colors flex justify-center items-center gap-2 border border-red-100 dark:border-red-500/20">
  ...
  <div v-if="showLinkModal" class="absolute inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-end sm:items-center justify-center p-4 sm:p-0">
        <div class="absolute inset-0" @click="fermerModaleLien"></div>
        
        <div class="bg-white dark:bg-gray-800 w-full max-w-sm rounded-3xl p-6 shadow-2xl relative z-10 animate-fade-in-up transition-colors">
